...
const requestGithubCard = (followersArray) => {
	followersArray.map((handle) => {
		return axios
...
requestGithubCard(followersArray);
...
const createGithubUserCard = (user = {}) => {
	...
	githubPageAddress.href = user.html_url;
	githubPageAddress.textContent = user.html_url;
